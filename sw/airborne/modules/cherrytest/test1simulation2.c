...
int avoid_detection1()
{
  ...
  float own_pos_utm_y = stateGetPositionUtm_f()->north;
  ...
  printf("drone %d: d_oi %f utm x y %f %f enu x y %f %f intr x y %f %f\n",AC_ID,d_oi,own_pos_utm_x,own_pos_utm_y,own_pos_x,own_pos_y,intr_pos_x,intr_pos_y);
